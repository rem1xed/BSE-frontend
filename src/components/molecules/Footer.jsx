        ...
        <footer >
            ...
            <div className={style.side}>
                <ul className={style.list}>
                    ...
                    <li className={style.list_element}>Phones:<span className={style.span_footer}>(00)1234 56789</span></li>
                    ...
                    <li className={style.list_element}><a className={style.link} href="#">E-mail: <span className={style.span_footer}>shop@email.com</span></a></li>
                </ul>
            </div>
        </footer>
    )
